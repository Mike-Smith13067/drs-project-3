...
const p1 = "Whether your vehicle is showing obvious signs of a problem or you noticed the âcheck engineâ light is on, a quick car diagnostic test by an expert technician can help pinpoint the problem.";
...
class Home extends Component {
  componentDidMount() {
    ...
    const nextSlide = () => {
      ...
      var h2Array = [h21, h22, h23, h24, h25];
